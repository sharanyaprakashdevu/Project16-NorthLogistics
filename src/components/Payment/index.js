...
const Payment = (props) => {
    const {procedeToPay,backTo} = props;
  return (
    <div style={{ width: "600px" }}>
      <div className="ccontainer">
        <div className="row">
                ...
                <div className="collapse show p-3 pt-0" id="collapseExample">
                  <div className="row">
                    ...
                    <div className="col-lg-7">
                      <form action="" onSubmit={procedeToPay} className="form">
                        <div className="row">
                          <div className="col-12">
          ...
          <button className=" w-100 btn btn-primary payment ml-auto" onClick={()=>{backTo()}}>Back</button>
          </div>
        </div>
      </div>
    </div>
